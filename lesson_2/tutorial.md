...
*Following instructions from: https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account*
...
1. From your repo's GitHub page, find the `Qucik setup` instructions
...
* We can potentially connect multiple remote repository to push/fetch
  code to/from.
